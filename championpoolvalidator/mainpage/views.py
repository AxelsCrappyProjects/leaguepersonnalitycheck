...
def discord_api(request, summoner_name, region):
    ...
    if request.method == "GET":
        ...
        rest = round(rest, 2)
        normal = round(100 - unvalidated_percentage, 2)
        words['normal'] = {'percentage': normal, 'champions': ['Respectable champions']}
        words['others'] = {'percentage': rest, 'champions': ['Other non-respectable champions']}
        champion_masteries = sorted(champion_masteries, key=lambda x : x.percentage)
